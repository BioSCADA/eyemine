...
${OBJECTDIR}/Eyemine.o: Eyemine.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Eyemine.o Eyemine.cpp

${OBJECTDIR}/FaceDetect.o: FaceDetect.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FaceDetect.o FaceDetect.cpp

${OBJECTDIR}/FaceHeuristics.o: FaceHeuristics.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FaceHeuristics.o FaceHeuristics.cpp

${OBJECTDIR}/JavaStartInterface.o: JavaStartInterface.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/JavaStartInterface.o JavaStartInterface.cpp

${OBJECTDIR}/LeftContours.o: LeftContours.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LeftContours.o LeftContours.cpp

${OBJECTDIR}/LeftEyeDetect.o: LeftEyeDetect.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LeftEyeDetect.o LeftEyeDetect.cpp

${OBJECTDIR}/LeftEyeTrack.o: LeftEyeTrack.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LeftEyeTrack.o LeftEyeTrack.cpp

${OBJECTDIR}/MouthContours.o: MouthContours.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MouthContours.o MouthContours.cpp

${OBJECTDIR}/MouthDetect.o: MouthDetect.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MouthDetect.o MouthDetect.cpp

${OBJECTDIR}/MouthTrack.o: MouthTrack.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MouthTrack.o MouthTrack.cpp

${OBJECTDIR}/MultiCamera.o: MultiCamera.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MultiCamera.o MultiCamera.cpp

${OBJECTDIR}/NoseDetect.o: NoseDetect.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NoseDetect.o NoseDetect.cpp

${OBJECTDIR}/NoseTrack.o: NoseTrack.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NoseTrack.o NoseTrack.cpp

${OBJECTDIR}/RightCamShift.o: RightCamShift.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RightCamShift.o RightCamShift.cpp

${OBJECTDIR}/RightContours.o: RightContours.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RightContours.o RightContours.cpp

${OBJECTDIR}/RightEyeDetect.o: RightEyeDetect.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RightEyeDetect.o RightEyeDetect.cpp

${OBJECTDIR}/RightEyeTrack.o: RightEyeTrack.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RightEyeTrack.o RightEyeTrack.cpp

${OBJECTDIR}/RightHough.o: RightHough.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RightHough.o RightHough.cpp

${OBJECTDIR}/TrackerDetector.o: TrackerDetector.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TrackerDetector.o TrackerDetector.cpp
